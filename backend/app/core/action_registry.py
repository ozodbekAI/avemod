...
ACTION_REGISTRY: dict[str, ActionRegistryEntry] = {
    ...
    "open_reputation": ActionRegistryEntry(
        action_code="open_reputation",
        ...
        allowed_in_rule_builder=True,
        allowed_for_seller=True,
        target_route_template="/reputation",
    ),
...
ACTION_ALIASES: dict[str, str] = {
    ...
    "review_reputation": "open_reputation",
    "reply_review": "open_reputation",
    "reply_question": "open_reputation",
